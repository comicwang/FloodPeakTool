...
### 1.0.6305.17324
*  【新增功能】增加iTelluro.DataTools.Utillity.Numeral.Math类
*  【新增功能】DemHelp类增加几个方法  
*  【新增功能】线程池Pool增加挂起和继续方法以支持任务暂停  
*  【新增功能】IOHelp类增加fread方法以替代c++的读文件方法  

### 1.0.6169.21666
*  【新增功能】GCPWarp类增加VectorWarp方法用于利用控制点纠正矢量文件。
*  【修改BUG】修改Marshal.RunExeWithHiddenModeAsync方法的bug

### 1.0.6164.33819
*  【修改BUG】修改Marshal类调用exe方法某些情况下的bug
*  【修改BUG】BilDemFile类生成csv文件，自动识别值类型导出。
*  【新增功能】GIS命名空间下新增GCPWarp类用于利用控制点纠正影像。
*  【新增功能】CoordSystem类下新增方法SetCoordSystem用于为影像设置坐标系
*  【新增功能】GIS命名空间下新增Coord类，用于度分秒字符串和带小数度数间的相互转换。

### 1.0.6163.29830
*  【新增功能】CoordTransform类增加高斯正算GaussGeoToPrj和高斯反算GaussPrjToGeo
*  【修改BUG】修改DOM切图模块的bug
